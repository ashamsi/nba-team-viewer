...
private const val TAG = "GetTeamsSortedByNameDescUseCase"

/**
 * [UseCase] to get [TeamEntity]'s. sorted by [TeamEntity.name] descending order.
 */
class GetTeamsSortedByNameDescUseCase : UseCase<List<TeamEntity>, List<TeamEntity>> {
